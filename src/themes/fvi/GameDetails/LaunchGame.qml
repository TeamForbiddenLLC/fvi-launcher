...
id: root
	...
	property string savedText : "Warfork"
    ...
    id: screenshot
        ...
        anchors.fill: parent
		source: "http://forbidden.gg/assets/media/theme/bg_blank.gif"     
//      source: "http://forbidden.gg/assets/media/theme/bg_" + settings.Skin + ".jpg"       
        asynchronous: true
